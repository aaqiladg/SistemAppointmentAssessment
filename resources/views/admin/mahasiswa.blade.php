...
<div class="container mt-3">
  ...
  <table class="table table-hover">
    ...
    <div class="btn-group" role="group" aria-label="Basic example">
      <a href = "{{ url('mahasiswa') }}"><button type="button" class="btn btn-warning">Mahasiswa</button></a>
   <a href = "{{ url('dosen') }}"><button type="button" class="btn btn-warning">Dosen</button></a>
   <a href = "{{ url('jadwal') }}"><button type="button" class="btn btn-warning">Jadwal</button></a>
</div>
